...
import { differentAddress, getRandomInt, getRandomTon, randomAddress } from './utils';
...
describe('JettonWallet', () => {
    ...
    beforeAll(async () => {
        ...
        testBurnFees = async (fees, to, amount, exp, custom_payload, prices) => {
            ...
            const burnBody = JettonWallet.burnMessage(amount, to, custom_payload ?? undefined);
    ...
    it('storage stats', async () => {
        ...
        const res = await deployerJettonWallet.sendBurn(deployer.getSender(), toNano('1'), 0n, undefined, undefined);
    ...
    */
    ...
    describe('Remove governance', () => {
        ...
        it('minter should not be able to force burn tokens', async () => {
            ...
            const burnMessage = JettonWallet.burnMessage(1n, undefined, undefined);
    ...
    describe('Bounces', () => {
        ...
        it('wallet should restore balance on burn_notification bounce', async () => {
            ...
            const burnMsg = JettonWallet.burnMessage(burnAmount, deployer.address);
